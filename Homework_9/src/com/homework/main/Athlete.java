 ...
 * that have the goal to define our Athletes
...
public class Athlete {
    ...
    public Athlete(int athleteNumber, String athleteName, String countryCode, int minutes, int seconds, String firstShooting, String secondShooting, String thirdShooting) {
